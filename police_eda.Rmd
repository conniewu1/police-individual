...
most_pop <- tail(names(sort(table(final_eda$city))), 6)
...
for (c in most_pop) {
  ...
  vic <- temp %>% 
  summarise(total_b = sum(str_count(SubjectRace, "B")), 
            total_w = sum(str_count(SubjectRace, "W")),
            total_l = sum(str_count(SubjectRace, "L")),
            total_a = sum(str_count(SubjectRace, "A")),
            total_o = sum(str_count(SubjectRace, "O")))
...
ggsave(filename = "figures/eda1.png", race_count)
ggsave(filename = "figures/eda2.png", race_prop)
```
...
ggsave(filename = "figures/eda3.png", race_count1)
ggsave(filename = "figures/eda4.png", race_prop1)
```
