...
rand_fit1 <- glmer(fatal ~ SubjectRace + ob + ow + omult + gun + weapon_other + 
    replica + knife + unarmed + (1 | city), data = single_victims, family = "binomial", nAGQ=50)
summary(rand_fit1)
coef(rand_fit1)
fixef(rand_fit1)
ranef(rand_fit1)
...
m0 <- 'fatal ~ SubjectRace + ob + ow + omult + gun + weapon_other + replica + knife + unarmed + (1 | city)'
...
rand_fit2 <- glmer(fatal ~ SubjectRace + ob + ow + omult + gun + weapon_other + 
    replica + knife + unarmed + (SubjectRace | city), data = single_victims, family = "binomial", control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
summary(rand_fit2)
coef(rand_fit2)
fixef(rand_fit2)
ranef(rand_fit2)
...
m0 <- 'fatal ~ SubjectRace + ob + ow + omult + gun + weapon_other + replica + knife + unarmed + (SubjectRace | city)'
p0 <- crossvalidate(data, k = 5, model = m0, dependent = 'fatal', random = TRUE)
p0
mean(p0)
...
rand_fit3 <- glmer(fatal ~ SubjectRace + ob + ow + omult + gun + weapon_other + 
    replica + knife + unarmed + (1 + SubjectRace | city), data = single_victims, family = "binomial", control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
summary(rand_fit3)
coef(rand_fit3)
fixef(rand_fit3)
ranef(rand_fit3)
...
m0 <- 'fatal ~ SubjectRace + ob + ow + omult + gun + weapon_other + replica + knife + unarmed + (1 + SubjectRace | city)'
p0 <- crossvalidate(data, k = 5, model = m0, dependent = 'fatal', random = TRUE)
p0
mean(p0)
...
m0 <- 'fatal ~ SubjectRace + ob + ow + omult + gun + weapon_other + replica + knife + unarmed + (1 + gun | city) + SubjectGender'
p0 <- crossvalidate(data, k = 5, model = m0, dependent = 'fatal', random = TRUE)
p0
mean(p0)
