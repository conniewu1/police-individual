...
|        After merging the three datasets, the final dataset consists of 2,038 observations and 34 columns.
...
|       Upon first glance, there appears to be 1,890 incidents in the final dataset in which there was only one victim, and 148 with multiple victims. Among these, 
