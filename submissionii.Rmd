...
```{r, figures-btw, fig.show="hold", out.width="50%", fig.cap="City Black to White Ratios Distributions for Fatal vs. Non-Fatal Police Shootings"}
par(mar = c(2, 2, .1, .1))
