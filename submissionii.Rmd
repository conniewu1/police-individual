...
$$
$$
\beta_{10}\ black\_officer\_present_i + \beta_{11}\ white\_officer\_present_i + \beta_{12}\ latino\_officer\_present_i + \beta_{13} victim\_armed\_gun
$$
$$
...
$$
$$
+ \beta_{8} victim\_armed\_gun + \beta_{9} victim\_armed\_gun
$$
\end{center}
...
### Analysis Plan
|        Preliminarily, it appears that none of the legislation variables were significant in predicting whether one was shot fatally or not, and thus were not included in either of the models. 
