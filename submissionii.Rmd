...
all$OfficerRace <- gsub("Unknown", "U", all$OfficerRace)
all$OfficerRace <- gsub("m/m", "U", all$OfficerRace)
all$OfficerRace <- gsub("WHITE", "W", all$OfficerRace)
all$OfficerRace <- gsub("WLITE", "W", all$OfficerRace)
all$OfficerRace <- gsub("BLACK", "B", all$OfficerRace)
all$OfficerRace <- gsub("ASIAN", "A", all$OfficerRace)
all$OfficerRace <- gsub("Other", "O", all$OfficerRace)
all$OfficerRace <- gsub("AI/AN", "O", all$OfficerRace)
all$OfficerRace <- gsub("A/PI ", "A;", all$OfficerRace)
all$OfficerRace <- gsub("A/PI", "A", all$OfficerRace)
all$OfficerRace <- gsub("Multi-Racial", "O", all$OfficerRace)
all$OfficerRace <- gsub(",", ";", all$OfficerRace)
all$OfficerRace <- gsub(" ", "", all$OfficerRace)
all$OfficerRace <- gsub("A/W", "O", all$OfficerRace)
all$OfficerRace <- gsub("NA/W", "O", all$OfficerRace)
all$OfficerRace <- gsub("W/L", "O", all$OfficerRace)
all$OfficerRace <- gsub("W/A", "O", all$OfficerRace)
...
all$ob <- as.numeric(str_count(all$OfficerRace, "B") > 0)
all$ow <- as.numeric(str_count(all$OfficerRace, "W") > 0)
all$ol <- as.numeric(str_count(all$OfficerRace, "L") > 0)
all$oa <- as.numeric(str_count(all$OfficerRace, "A") > 0)
...
```
|       Upon first glance, there appears to be 3906 incidents in which there was only one victim, and 210 with multiple victims. This means that there is one incident in which the victim race was marked as "NA." Additionally, 
